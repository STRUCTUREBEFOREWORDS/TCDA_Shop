...
export function TopPage() {
  ...
  return (
    <div className="min-h-screen bg-black">
      ...
      {/* SECTION 3 — DIMENSION */}
      <section style={{ position: "relative", width: "100%", overflowX: "hidden" }}>
        <img src="https://cdn.tcdashop.com/top/010-desktop.webp" srcSet="https://cdn.tcdashop.com/top/010-mobile.webp 828w, https://cdn.tcdashop.com/top/010-desktop.webp 1440w" sizes="(max-width: 768px) 828px, 1440px" alt="" loading="eager" decoding="async" style={{ width: "100%", display: "block" }} />
        <div style={{ position: "absolute", inset: 0, background: "rgba(0,0,0,0.3)", zIndex: 1 }} />
      ...
      {/* SECTION 4 — AURA */}
      <section style={{ position: "relative", width: "100%", overflowX: "hidden" }}>
        <img src="https://cdn.tcdashop.com/top/011-desktop.webp" srcSet="https://cdn.tcdashop.com/top/011-mobile.webp 828w, https://cdn.tcdashop.com/top/011-desktop.webp 1440w" sizes="(max-width: 768px) 828px, 1440px" alt="" loading="eager" decoding="async" style={{ width: "100%", display: "block" }} />
        <div style={{ position: "absolute", inset: 0, background: "rgba(0,0,0,0.3)", zIndex: 1 }} />
