...
// ─── Size guide image map ────────────────────────────────────────────────────
// Maps normalized size_category → custom garment guide image path (served from public/).
...
const SIZE_GUIDE_IMAGE_MAP: Record<string, string> = {
  mens_crew_neck:       "/size-guide/mens-tee-guide.webp",
  womens_crew_neck:     "/size-guide/womens-tee-guide.webp",
  unisex_hoodie:        "/size-guide/unisex-hoodie-guide.webp",
  unisex_zip_hoodie:    "/size-guide/unisex-zip-hoodie-guide.webp",
  shorts:               "/size-guide/shorts.webp",
  athletic_long_shorts: "/size-guide/athletic_long_shorts.webp",
  crop_tee:             "/size-guide/crop_tee.webp",
  crop_top_ls:          "/size-guide/crop_top_ls.webp",
  recycled_sweatshirt:  "/size-guide/recycled_sweatshirt.webp",
  track_jacket:         "/size-guide/track_jacket.webp",
  windbreaker_mens:       "/size-guide/windbreaker_mens.webp",
  windbreaker_womens:     "/size-guide/windbreaker_womens.webp",
  athletic_tshirt_womens: "/size-guide/womens_athletic.webp",
  athletic_tshirt_mens:   "/size-guide/mens_athletic.webp",
  large_tote_bag:         "/size-guide/large_tote_bag.webp",
  tote_bag:               "/size-guide/tote_bag.webp",
...
/**
 * Normalise size_category strings so minor naming variations from Printful
 * or manual entries (e.g. "hoodie" vs "unisex_hoodie") all hit the same key.
 */
function normalizeSizeCategory(value?: string | null): string | null {
  if (!value) return null;
  const v = value.trim().toLowerCase();
  if (["mens_crew", "mens_crew_neck"].includes(v)) return "mens_crew_neck";
...
export function SizeGuideModal({
  ...
  const guideImageSrc =
    ...
    measuringGuideImageUrl ||
    sizeChart?.chart_data?.measure_yourself_image_url ||
    null;
            ...
            <div ref={scrollRef} className="flex-1 overflow-y-auto px-8 py-6 space-y-8">
              ...
              <div className="border-b border-white/5 pb-8">
                ...
                {guideImageSrc && (
                  <img
                    src={guideImageSrc}
                    alt={t("sizeGuide.figureAlt", { product: productName })}
