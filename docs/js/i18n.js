...
(function (global) {
  ...
  const TRANSLATIONS = {
    ...
    /* ── 한국어 ───────────────────────────────────────────────── */
    ko: {
      title_home: "TCDA | 아트를 입다, 감성을 해방하다",
      title_brand: "브랜드 | TCDA",
      title_collection: "컬렉션 | TCDA",
      title_lookbook: "룩북 | TCDA",
      title_archive: "아카이브 | TCDA",
      title_shop: "쇼핑 | TCDA",
      title_product_cnj: "크로마 노이즈 재킷 | TCDA",
      nav_home: "홈",
      nav_art: "아트",
      nav_brand: "브랜드",
      nav_about: "소개",
      ...
      cart_added: "추가됨",
      cart_add: "장바구니에 담기",
      footer_tagline: "Transcend Color Digital Apparel / 아트를 입다, 감성을 해방하다.",
      footer_tech: "HTTPS 지원, Cloudflare 호환, 보안 결제 플레이스홀더 포함.",
      skip_link: "콘텐츠로 건너뛰기",
      home_eyebrow: "Transcend Color Digital Apparel",
      home_h1_html: "아트를 입다,<br />감성을 해방하다.",
      home_lead: "추상적인 색채 구성이 착용 가능한 표현이 되는 프리미엄 디지털 아트 어패럴 하우스. 경험은 아트에서 시작해 철학으로, 그리고 제품 발견으로 이어집니다.",
      home_btn_shop: "쇼핑 입장",
      home_btn_lookbook: "룩북 보기",
      home_hero_img_alt: "몰입형 추상 컬러 스타일링의 패션 모델",
      home_phi_eyebrow: "철학",
      home_phi_h2: "입을 수 있는 디지털 아트 미술관",
      home_phi_p1: "TCDA는 의류를 움직이는 갤러리 벽으로 다룹니다. 모든 드롭은 추상 디지털 아트 작품에서 시작하여 텍스타일, 실루엣, 모션으로 번역됩니다.",
      home_phi_p2: "우리의 세계는 고요한 강렬함을 위해 구축되었습니다: 중립적 공간, 정확한 색채 재현, 그리고 의도적인 시각적 리듬.",
      home_phi_link: "브랜드 스토리 탐색",
      home_feat_eyebrow: "주목 컬렉션",
      home_feat_h2: "크로마틱 드리프트",
      home_feat_link: "전체 작품 보기",
      home_journey_eyebrow: "여정",
      home_journey_h2: "아트 영감에서 구매 결정까지",
      home_journey_p: "갤러리 몰입에서 시작하여 철학을 이해하고, 현실 착용을 위해 설계된 작품을 발견하세요.",
      home_journey_shop: "컬렉션 쇼핑",
      home_journey_lookbook: "룩북 열기",
      home_hero_title: "입을 수 있는 아트.",
      home_hero_lead_new: "TCDA는 아트 갤러리이자 패션 브랜드입니다. 세계관으로 입장하여 작품을 발견하고, 당신의 이야기의 일부가 될 작품을 선택하세요.",
      home_cta_collection: "컬렉션 보기",
      home_cta_artwork: "아트워크 보기",
      home_art_eyebrow: "주목 아트워크",
      home_art_h2: "갤러리 프래그먼트",
      home_art_link: "아트 아카이브 열기",
      home_art_meta: "아트워크",
      home_col_eyebrow_new: "컬렉션",
      home_col_h2_new: "후디 / 티셔츠 / 슈즈",
      home_col_link_new: "쇼핑으로 이동",
      home_cat_hoodie: "후디",
      home_cat_hoodie_desc: "일상 레이어드를 위한 구조적 실루엣.",
      home_cat_tshirt: "티셔츠",
      home_cat_tshirt_desc: "갤러리 수준의 색상 표현 고해상도 올오버 프린트.",
      home_cat_shoes: "슈즈",
      home_cat_shoes_desc: "시각적 언어를 완성하는 움직임 중심의 작품.",
      home_story_eyebrow: "브랜드 스토리",
      home_story_h2: "Wear Art. Liberate Sensibility.",
      home_story_p1: "우리는 의류를 물건으로 판매하지 않습니다. 색, 기억, 움직임이 정체성이 되는 세계의 입구를 설계합니다.",
      home_story_p2: "경로는 의도적입니다: 세계관, 작품, 컬렉션, 신뢰, 그리고 구매.",
      home_story_link: "컨셉 읽기",
      home_social_eyebrow: "소셜",
      home_social_h2: "Instagram 저널",
      home_social_p: "작품 연구, 드롭 진행 상황, 에디토리얼 미리보기를 팔로우하세요.",
      home_social_btn: "Instagram 열기",
      home_social_lookbook: "룩북 보기",
      home_footer_line: "Transcend Color Digital Apparel / 아트 갤러리 + 패션 EC",
      brand_eyebrow: "브랜드",
      brand_h1_html: "아트가 의류가 되고,<br />의류가 목소리가 된다.",
      brand_lead: "TCDA는 추상 디지털 아트와 프리미엄 의류 제작을 융합하기 위해 존재합니다. 일상의 움직임에 감정적 색채 건축을 담은 착용 가능한 작품을 디자인합니다.",
      brand_hero_img_alt: "디지털 아트 패션 의류를 형성하는 크리에이티브 디렉터",
      brand_concept_eyebrow: "웨어러블 아트",
      brand_concept_h2: "컨셉",
      brand_concept_p: "각 릴리스는 원본 디지털 캔버스에서 시작됩니다. 색, 노이즈, 그라데이션 레이어가 텍스처, 컷, 실루엣에 매핑되어 물리적 형태에서 시각적 강도를 보존합니다.",
      brand_method_eyebrow: "크리에이티브 철학",
      brand_method_h2: "방법론",
      brand_method_p: "아트워크가 숨쉴 수 있도록 시각적 노이즈를 제거합니다. 중립적 환경, 절제된 타이포그래피, 영화적 간격이 초점을 색과 형태에 맞춥니다.",
      brand_process_eyebrow: "스토리텔링",
      brand_process_h2: "3단계 창작 프로세스",
      brand_step1_meta: "01 아트 창작",
      brand_step1_h3: "디지털 추상",
      brand_step1_p: "원본 아트워크는 감정, 리듬, 색채 정밀도를 위해 생성하고 큐레이션됩니다.",
      brand_step2_meta: "02 텍스타일 번역",
      brand_step2_h3: "소재와의 대화",
      brand_step2_p: "색채 데이터는 색조 깊이를 보존하면서 프린트와 패브릭 거동으로 번역됩니다.",
      brand_step3_meta: "03 에디토리얼 실현",
      brand_step3_h3: "웨어러블 표현",
      brand_step3_p: "최종 의류는 영화적 존재감, 편안함, 지속적인 시각적 정체성을 위해 형성됩니다.",
      brand_footer_p: "TCDA 브랜드 스토리",
      brand_footer_link: "컬렉션으로 계속",
      col_eyebrow: "컬렉션",
      col_h1: "착용 가능한 색채 작품의 갤러리",
      col_lead: "각 아이템은 형태, 빛, 색채 임팩트에 초점을 맞춘 독립적인 갤러리 작품으로 제시됩니다.",
      col_drop_eyebrow: "현재 드롭",
      col_drop_h2: "크로마틱 드리프트 시리즈",
      col_drop_link: "이 드롭 쇼핑하기",
      col_footer_p: "TCDA 컬렉션",
      col_footer_link: "상품 페이지 열기",
      lb_eyebrow: "룩북",
      lb_h1: "모션 속의 에디토리얼 프레임",
      lb_lead: "제품 결정 전에 시청자를 몰입시키기 위해 설계된 대형 패션 이미지.",
      lb_vol_eyebrow: "볼륨 01",
      lb_vol_h2: "컬러필드의 메아리",
      lb_ch1_meta: "챕터 01",
      lb_ch1_h3: "문턱",
      lb_ch1_p: "실루엣이 색채 밀도와 만나는 고요한 오프닝.",
      lb_ch2_meta: "챕터 02",
      lb_ch2_h3: "간섭",
      lb_ch2_p: "색채 그라데이션이 신체 움직임과 빛에 따라 변합니다.",
      lb_ch3_meta: "챕터 03",
      lb_ch3_h3: "해방",
      lb_ch3_p: "시각 언어이자 개인 서명으로서의 의류.",
      lb_footer_p: "TCDA 룩북",
      lb_footer_link: "쇼핑으로 이동",
      arc_eyebrow: "아카이브",
      arc_h1: "오리지널 디지털 아트워크 라이브러리",
      arc_lead: "추상 작품이 의류로 변환되기 전에 큐레이션되는 소스 아카이브.",
      arc_art_eyebrow: "아트워크",
      arc_art_h2: "스펙트럼 프래그먼트",
      arc_a019_h3: "컬러 에코 플레인",
      arc_a027_h3: "베이퍼 컨투어 그리드",
      arc_a031_h3: "뮤트 프리즘 시프트",
      arc_footer_p: "TCDA 아카이브",
      arc_footer_link: "의류 번역 보기",
      shop_eyebrow: "쇼핑",
      shop_h1: "미니멀 상품 그리드",
      shop_lead: "깔끔한 카드, 고해상도 미리보기, 미래 API 통합을 위한 보안 결제 플레이스홀더.",
      shop_checkout_btn: "보안 결제 플레이스홀더",
      shop_checkout_status: "결제 백엔드가 미래 Stripe/Printful 통합을 위해 준비되었습니다.",
      shop_footer_p: "TCDA 쇼핑",
      shop_footer_tech: "시맨틱 마크업, 경량 코드, WebP 최적화 비주얼.",
      prod_cnj_eyebrow: "아우터 / 한정판",
      prod_cnj_title: "크로마 노이즈 재킷",
      prod_cnj_tag1: "아트워크 매핑 프린트",
      prod_cnj_tag2: "유니섹스 핏",
      prod_cnj_tag3: "한정 드롭",
      prod_cnj_art_h2: "아트워크 설명",
      prod_cnj_art_p: "디지털 아카이브 작품 A-019에서 영감을 받은 이 재킷은 시안 간섭과 어두운 입상 리듬을 포착합니다. 구조는 움직임 속에서 색채 임팩트를 보존하도록 설계되었습니다.",
      prod_cnj_mat_h2: "소재 정보",
      prod_cnj_mat_li1: "셸: 100% 재활용 기술 폴리에스터",
      prod_cnj_mat_li2: "안감: 통기성 큐프라 혼방",
      prod_cnj_mat_li3: "프린트: 색상 정확도를 위한 고품질 전사",
      prod_cnj_mat_li4: "생산: 소량 배치 장인 정신, 일본 제조",
      prod_cnj_size_meta: "사이즈",
      prod_cnj_add: "장바구니에 담기",
      prod_cnj_checkout: "보안 결제 플레이스홀더",
      prod_cnj_back: "쇼핑으로 돌아가기",
      prod_cnj_status: "향후 통합: Stripe, Printful API, 주문 시스템, 고객 계정.",
      prod_cnj_notice: "Cloudflare 호환 아키텍처 및 HTTPS 우선 배포 권장.",
      prod_cnj_size_table: "사이즈표",
      prod_cnj_size_col_size: "사이즈",
      prod_cnj_size_col_chest: "가슴 너비",
      prod_cnj_size_col_sleeve: "소매 길이",
      prod_cnj_size_col_length: "총장",
      prod_related_eyebrow: "관련 상품",
      prod_related_h2: "스토리를 완성하다",
      prod_footer_p: "TCDA 상품 페이지",
      prod_footer_link: "오리지널 아트워크 아카이브 보기",
      cat_outerwear: "아우터",
      cat_dress: "드레스",
      cat_shirt: "셔츠",
      cat_coat: "코트",
      cat_bottoms: "보텀",
      cat_set: "세트",
      prod_chroma_jacket: "크로마 노이즈 재킷",
      prod_spectral_dress: "스펙트럴 베일 드레스",
      prod_prism_shirt: "프리즘 사일런스 셔츠",
      prod_cyan_coat: "시안 에코 코트",
      prod_afterglow: "애프터글로우 트라우저",
      prod_monochrome: "모노크롬 드리프트 세트",
      prod_spectrum_fold: "스펙트럼 폴드 드레스",
      lang_label: "언어",
      currency_label: "통화",
    },
    ...
    /* ── Français ─────────────────────────────────────────────── */
    fr: {
      title_home: "TCDA | Porter l'Art, Libérer la Sensibilité",
      title_brand: "Marque | TCDA",
      title_collection: "Collection | TCDA",
      title_lookbook: "Lookbook | TCDA",
      title_archive: "Archives | TCDA",
      title_shop: "Boutique | TCDA",
      title_product_cnj: "Veste Chroma Noise | TCDA",
      nav_home: "Accueil",
      nav_art: "Art",
      nav_brand: "Marque",
      nav_about: "À propos",
      ...
      footer_tagline: "Transcend Color Digital Apparel / Porter l'Art, Libérer la Sensibilité.",
      footer_tech: "Prêt HTTPS, compatible Cloudflare, paiement sécurisé intégré.",
      skip_link: "Aller au contenu",
      home_eyebrow: "Transcend Color Digital Apparel",
      home_h1_html: "Porter l'Art,<br />Libérer la Sensibilité.",
      home_lead: "Une maison de mode numérique premium où des compositions chromatiques abstraites deviennent une expression portable. L'expérience commence par l'art, puis se déplace vers la philosophie, puis vers la découverte de produits.",
      home_btn_shop: "Entrer dans la Boutique",
      home_btn_lookbook: "Voir le Lookbook",
      home_hero_img_alt: "Mannequin de mode dans un style de couleur abstrait immersif",
      home_phi_eyebrow: "Philosophie",
      home_phi_h2: "Un Musée d'Art Numérique que Vous Pouvez Porter",
      home_phi_p1: "TCDA traite les vêtements comme des murs de galerie en mouvement. Chaque drop commence comme une œuvre d'art numérique abstraite et est traduit en textile, silhouette et mouvement.",
      home_phi_p2: "Notre monde est construit pour une intensité silencieuse : espace neutre, rendu précis des couleurs et rythme visuel délibéré.",
      home_phi_link: "Explorer l'Histoire de la Marque",
      home_feat_eyebrow: "Collection en Vedette",
      home_feat_h2: "Chromatic Drift",
      home_feat_link: "Voir Toutes les Pièces",
      home_journey_eyebrow: "Parcours",
      home_journey_h2: "De l'Inspiration Artistique à la Décision d'Achat",
      home_journey_p: "Commencez par l'immersion dans la galerie, comprenez la philosophie, puis découvrez des pièces conçues pour un usage quotidien.",
      home_journey_shop: "Acheter la Collection",
      home_journey_lookbook: "Ouvrir le Lookbook",
      home_hero_title: "L'art que vous pouvez porter.",
      home_hero_lead_new: "TCDA est à la fois une galerie d'art et une marque de mode. Entrez par le monde visuel, découvrez des œuvres, puis choisissez la pièce qui fait partie de votre histoire.",
      home_cta_collection: "Voir la Collection",
      home_cta_artwork: "Voir les Œuvres",
      home_art_eyebrow: "Œuvres en Vedette",
      home_art_h2: "Fragments de Galerie",
      home_art_link: "Ouvrir les Archives d'Art",
      home_art_meta: "Œuvre",
      home_col_eyebrow_new: "Collection",
      home_col_h2_new: "Hoodie / T-shirt / Chaussures",
      home_col_link_new: "Aller à la Boutique",
      home_cat_hoodie: "Hoodie",
      home_cat_hoodie_desc: "Silhouettes structurées pour une superposition quotidienne.",
      home_cat_tshirt: "T-shirt",
      home_cat_tshirt_desc: "Impression all-over haute fidélité avec une couleur de niveau galerie.",
      home_cat_shoes: "Chaussures",
      home_cat_shoes_desc: "Pièces axées sur le mouvement pour compléter le langage visuel.",
      home_story_eyebrow: "Histoire de la Marque",
      home_story_h2: "Wear Art. Liberate Sensibility.",
      home_story_p1: "Nous ne vendons pas des vêtements comme des objets. Nous concevons un point d'entrée dans un monde où la couleur, la mémoire et le mouvement deviennent identité.",
      home_story_p2: "Le chemin est intentionnel : vision du monde, œuvre, collection, confiance, puis achat.",
      home_story_link: "Lire le Concept",
      home_social_eyebrow: "Réseaux Sociaux",
      home_social_h2: "Journal Instagram",
      home_social_p: "Suivez les études d'œuvres, les drops en cours et les aperçus éditoriaux.",
      home_social_btn: "Ouvrir Instagram",
      home_social_lookbook: "Voir le Lookbook",
      home_footer_line: "Transcend Color Digital Apparel / Galerie d'Art + Mode EC",
      brand_eyebrow: "Marque",
      brand_h1_html: "L'Art Devient Vêtement,<br />Le Vêtement Devient Voix.",
      brand_lead: "TCDA existe pour fusionner l'art numérique abstrait avec la confection premium. Nous concevons des pièces portables qui portent l'architecture chromatique émotionnelle dans le mouvement quotidien.",
      brand_hero_img_alt: "Directeur créatif façonnant un vêtement de mode numérique",
      brand_concept_eyebrow: "Art Portable",
      brand_concept_h2: "Concept",
      brand_concept_p: "Chaque sortie commence à partir d'une toile numérique originale. Les couches de couleur, de bruit et de dégradés sont mappées sur la texture, la coupe et la silhouette, préservant l'intensité visuelle sous forme physique.",
      brand_method_eyebrow: "Philosophie Créative",
      brand_method_h2: "Méthode",
      brand_method_p: "Nous supprimons le bruit visuel pour que l'œuvre puisse respirer. Les environnements neutres, la typographie disciplinée et l'espacement cinématographique placent le focus là où il appartient : sur la couleur et la forme.",
      brand_process_eyebrow: "Narration",
      brand_process_h2: "Processus Créatif en Trois Étapes",
      brand_step1_meta: "01 Création Artistique",
      brand_step1_h3: "Abstraction Numérique",
      brand_step1_p: "L'œuvre originale est générée et sélectionnée pour l'émotion, le rythme et la précision chromatique.",
      brand_step2_meta: "02 Traduction Textile",
      brand_step2_h3: "Dialogue Matériel",
      brand_step2_p: "Les données de couleur sont traduites en comportement d'impression et de tissu tout en préservant la profondeur tonale.",
      brand_step3_meta: "03 Réalisation Éditoriale",
      brand_step3_h3: "Expression Portable",
      brand_step3_p: "Les vêtements finaux sont façonnés pour une présence cinématographique, un confort et une identité visuelle durable.",
      brand_footer_p: "Histoire de la Marque TCDA",
      brand_footer_link: "Continuer vers la Collection",
      col_eyebrow: "Collection",
      col_h1: "Galerie d'Œuvres de Couleur Portables",
      col_lead: "Chaque article est présenté comme une pièce de galerie autonome avec un accent sur la forme, la lumière et l'impact chromatique.",
      col_drop_eyebrow: "Drop Actuel",
      col_drop_h2: "Série Chromatic Drift",
      col_drop_link: "Acheter ce Drop",
      col_footer_p: "Collection TCDA",
      col_footer_link: "Ouvrir la Page Produit",
      lb_eyebrow: "Lookbook",
      lb_h1: "Cadres Éditoriaux en Mouvement",
      lb_lead: "Images de mode grand format conçues pour immerger les spectateurs avant la décision d'achat.",
      lb_vol_eyebrow: "Volume 01",
      lb_vol_h2: "Échos du Champ de Couleur",
      lb_ch1_meta: "Chapitre 01",
      lb_ch1_h3: "Seuil",
      lb_ch1_p: "Une ouverture calme où la silhouette rencontre la densité chromatique.",
      lb_ch2_meta: "Chapitre 02",
      lb_ch2_h3: "Interférence",
      lb_ch2_p: "Les dégradés de couleur changent avec le mouvement du corps et la lumière.",
      lb_ch3_meta: "Chapitre 03",
      lb_ch3_h3: "Libération",
      lb_ch3_p: "Le vêtement comme langage visuel et signature personnelle.",
      lb_footer_p: "Lookbook TCDA",
      lb_footer_link: "Aller à la Boutique",
      arc_eyebrow: "Archives",
      arc_h1: "Bibliothèque d'Art Numérique Original",
      arc_lead: "L'archive source où les œuvres abstraites sont sélectionnées avant d'être transformées en vêtements.",
      arc_art_eyebrow: "Œuvres d'Art",
      arc_art_h2: "Fragments du Spectre",
      arc_a019_h3: "Plan d'Écho de Couleur",
      arc_a027_h3: "Grille de Contour Vapeur",
      arc_a031_h3: "Décalage de Prisme Sourd",
      arc_footer_p: "Archives TCDA",
      arc_footer_link: "Voir les Traductions de Vêtements",
      shop_eyebrow: "Boutique",
      shop_h1: "Grille de Produits Minimaliste",
      shop_lead: "Cartes épurées, aperçus haute résolution et espace réservé de paiement sécurisé prêt pour la future intégration API.",
      shop_checkout_btn: "Espace Réservé de Paiement Sécurisé",
      shop_checkout_status: "Backend de paiement prêt pour la future intégration Stripe/Printful.",
      shop_footer_p: "Boutique TCDA",
      shop_footer_tech: "Balisage sémantique, code léger, visuels optimisés WebP.",
      prod_cnj_eyebrow: "Veste / Édition Limitée",
      prod_cnj_title: "Veste Chroma Noise",
      prod_cnj_tag1: "Impression Mappée sur Œuvre",
      prod_cnj_tag2: "Coupe Unisexe",
      prod_cnj_tag3: "Drop Limité",
      prod_cnj_art_h2: "Description de l'Œuvre",
      prod_cnj_art_p: "Inspirée de la pièce d'archive numérique A-019, cette veste capture l'interférence cyan et le rythme granulaire sombre. La structure est conçue pour préserver l'impact des couleurs sous le mouvement.",
      prod_cnj_mat_h2: "Informations sur les Matériaux",
      prod_cnj_mat_li1: "Coque : 100% polyester technique recyclé",
      prod_cnj_mat_li2: "Doublure : mélange de cupro respirant",
      prod_cnj_mat_li3: "Impression : transfert haute fidélité pour la précision des couleurs",
      prod_cnj_mat_li4: "Production : artisanat en petits lots, fabriqué au Japon",
      prod_cnj_size_meta: "Taille",
      prod_cnj_add: "Ajouter au Panier",
      prod_cnj_checkout: "Espace Réservé de Paiement Sécurisé",
      prod_cnj_back: "Retour à la Boutique",
      prod_cnj_status: "Intégrations futures : Stripe, API Printful, système de commandes, comptes clients.",
      prod_cnj_notice: "Architecture compatible Cloudflare et déploiement HTTPS-first recommandés.",
      prod_cnj_size_table: "Tableau des Tailles",
      prod_cnj_size_col_size: "Taille",
      prod_cnj_size_col_chest: "Largeur de Poitrine",
      prod_cnj_size_col_sleeve: "Longueur de Manche",
      prod_cnj_size_col_length: "Longueur Totale",
      prod_related_eyebrow: "Produits Associés",
      prod_related_h2: "Compléter l'Histoire",
      prod_footer_p: "Page Produit TCDA",
      prod_footer_link: "Voir les Archives d'Art Original",
      cat_outerwear: "Veste",
      cat_dress: "Robe",
      cat_shirt: "Chemise",
      cat_coat: "Manteau",
      cat_bottoms: "Bas",
      cat_set: "Ensemble",
      prod_chroma_jacket: "Veste Chroma Noise",
      prod_spectral_dress: "Robe Spectral Veil",
      prod_prism_shirt: "Chemise Prism Silence",
      prod_cyan_coat: "Manteau Cyan Echo",
      prod_afterglow: "Pantalon Afterglow",
      prod_monochrome: "Ensemble Monochrome Drift",
      prod_spectrum_fold: "Robe Spectrum Fold",
      lang_label: "Langue",
