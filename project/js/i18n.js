...
(function (global) {
  ...
  const TRANSLATIONS = {
    ...
    en: {
      ...
      /* Footer */
      footer_tagline: "Transcend Color Digital Apparel / Wear Art, Liberate Sensibility.",
      footer_tech: "HTTPS ready, Cloudflare compatible, secure checkout placeholder included.",
      ...
      home_lead: "A premium digital art apparel house where abstract chromatic compositions become wearable expression. The experience begins with art, then moves into philosophy, then product discovery.",
      home_btn_shop: "Enter Shop",
      home_btn_lookbook: "View Lookbook",
      home_hero_img_alt: "Editorial fashion model in immersive abstract color styling",
      home_phi_eyebrow: "Philosophy",
      home_phi_h2: "A Digital Art Museum You Can Wear",
      home_phi_p1: "TCDA treats garments as moving gallery walls. Every drop starts as abstract digital artwork and is translated into textile, silhouette, and motion.",
      home_phi_p2: "Our world is built for quiet intensity: neutral space, accurate color rendering, and deliberate visual rhythm.",
      ...
      home_journey_p: "Start with gallery immersion, understand the philosophy, then discover pieces designed for real-world wear.",
      ...
      brand_lead: "TCDA exists to merge abstract digital art with premium garment craft. We design wearable pieces that carry emotional color architecture into everyday movement.",
      brand_hero_img_alt: "Creative director shaping a digital art fashion garment",
      brand_concept_eyebrow: "Wearable Art",
      brand_concept_h2: "Concept",
      brand_concept_p: "Each release starts from an original digital canvas. Layers of color, noise, and gradients are mapped to texture, cut, and silhouette, preserving visual intensity in physical form.",
      brand_method_eyebrow: "Creative Philosophy",
      brand_method_h2: "Method",
      brand_method_p: "We remove visual noise so the artwork can breathe. Neutral environments, disciplined typography, and cinematic spacing place focus where it belongs: on color and shape.",
      ...
      brand_step1_p: "Original artwork is generated and curated for emotion, rhythm, and chromatic precision.",
      brand_step2_meta: "02 Textile Translation",
      brand_step2_h3: "Material Dialogue",
      brand_step2_p: "Color data is translated into print and fabric behavior while preserving tonal depth.",
      brand_step3_meta: "03 Editorial Realization",
      brand_step3_h3: "Wearable Expression",
      brand_step3_p: "Final garments are shaped for cinematic presence, comfort, and lasting visual identity.",
      ...
      col_lead: "Each item is presented as a standalone gallery piece with focus on shape, light, and chromatic impact.",
      ...
      lb_lead: "Large-scale fashion imagery designed to immerse viewers before product decision.",
      ...
      arc_lead: "The source archive where abstract works are curated before being transformed into garments.",
      ...
      shop_lead: "Clean cards, high-resolution previews, and a secure checkout placeholder ready for future API integration.",
      shop_checkout_btn: "Secure Checkout Placeholder",
      shop_checkout_status: "Checkout backend ready for future Stripe/Printful integration.",
      shop_footer_p: "TCDA Shop",
      shop_footer_tech: "Semantic markup, lightweight code, WebP optimized visuals.",
      ...
      prod_cnj_art_p: "Inspired by digital archive piece A-019, this jacket captures cyan interference and dark granular rhythm. The structure is shaped to preserve color impact under movement.",
      ...
      prod_cnj_status: "Future integrations: Stripe, Printful API, order system, customer accounts.",
      prod_cnj_notice: "Cloudflare-compatible architecture and HTTPS-first deployment recommended.",
    ...
    zh: {
      ...
      home_lead: "一个高端数字艺术服装品牌，将抽象色彩构成转化为可穿戴的表达。体验从艺术开始，进入哲学，再走向商品发现。",
      home_btn_shop: "进入商店",
      home_btn_lookbook: "查看造型册",
      home_hero_img_alt: "沉浸式抽象色彩造型的时尚模特",
      home_phi_eyebrow: "哲学",
      home_phi_h2: "一件可以穿的数字艺术博物馆",
      home_phi_p1: "TCDA 将服装视为移动的画廊墙。每次发布都从抽象数字艺术作品开始，转化为面料、轮廓与动态。",
      home_phi_p2: "我们的世界为宁静的强度而建：中性空间、精准的色彩呈现，以及刻意的视觉节奏。",
      ...
      home_journey_p: "从沉浸式画廊体验开始，理解哲学，然后发现为现实穿着而设计的作品。",
      home_journey_shop: "选购系列",
      home_journey_lookbook: "打开造型册",
      brand_eyebrow: "品牌",
      brand_h1_html: "艺术化为服装，<br />服装化为声音。",
      brand_lead: "TCDA 致力于将抽象数字艺术与高端服装工艺融合。我们设计的可穿戴作品将情感色彩架构带入日常运动。",
      brand_hero_img_alt: "创意总监塑造数字艺术时装",
      brand_concept_eyebrow: "可穿戴艺术",
      brand_concept_h2: "概念",
      brand_concept_p: "每件作品始于一幅原创数字画布。色彩、噪点和渐变层次被映射到质感、裁剪和轮廓，在实体形态中保留视觉强度。",
      brand_method_eyebrow: "创意哲学",
      brand_method_h2: "方法",
      brand_method_p: "我们去除视觉噪点，让艺术品自由呼吸。中性环境、严谨的排版和电影质感的间距，将焦点放在色彩与形状上。",
      ...
      shop_eyebrow: "商店",
      shop_h1: "极简商品网格",
      shop_lead: "简洁卡片、高分辨率预览，以及为未来 API 集成准备好的安全结账占位符。",
      ...
      prod_cnj_art_p: "灵感来自数字档案作品 A-019，这件夹克捕捉了青色干涉与深色颗粒节奏。结构经过设计，在运动中保留色彩冲击。",
    ...
    es: {
      ...
      footer_tagline: "Transcend Color Digital Apparel / Viste el Arte, Libera la Sensibilidad.",
      footer_tech: "Listo para HTTPS, compatible con Cloudflare, con marcador de pago seguro.",
      skip_link: "Saltar al contenido",
      home_eyebrow: "Transcend Color Digital Apparel",
      home_h1_html: "Viste el Arte,<br />Libera la Sensibilidad.",
      home_lead: "Una casa de moda digital premium donde composiciones cromáticas abstractas se convierten en expresión portable. La experiencia comienza con el arte, luego pasa a la filosofía y al descubrimiento de productos.",
      ...
      home_phi_p1: "TCDA trata las prendas como paredes de galería en movimiento. Cada lanzamiento comienza como una obra de arte digital abstracta que se traduce en tejido, silueta y movimiento.",
      home_phi_p2: "Nuestro mundo está construido para la intensidad silenciosa: espacio neutro, representación precisa del color y ritmo visual deliberado.",
      ...
      home_journey_p: "Comienza con la inmersión en la galería, comprende la filosofía y descubre piezas diseñadas para el uso cotidiano.",
      home_journey_shop: "Comprar Colección",
      home_journey_lookbook: "Abrir Lookbook",
      brand_eyebrow: "Marca",
      brand_h1_html: "El Arte se Convierte en Ropa,<br />la Ropa se Convierte en Voz.",
      brand_lead: "TCDA existe para fusionar el arte digital abstracto con la confección premium. Diseñamos piezas portables que llevan la arquitectura cromática emocional al movimiento cotidiano.",
      brand_hero_img_alt: "Director creativo dando forma a una prenda de moda digital",
      brand_concept_eyebrow: "Arte Portable",
      brand_concept_h2: "Concepto",
      brand_concept_p: "Cada lanzamiento comienza desde un lienzo digital original. Las capas de color, ruido y degradados se mapean en textura, corte y silueta, preservando la intensidad visual en forma física.",
      brand_method_eyebrow: "Filosofía Creativa",
      brand_method_h2: "Método",
      brand_method_p: "Eliminamos el ruido visual para que la obra respire. Entornos neutros, tipografía disciplinada y espaciado cinematográfico enfocan la atención donde corresponde: en el color y la forma.",
      ...
      brand_step1_p: "La obra original se genera y selecciona por emoción, ritmo y precisión cromática.",
      brand_step2_meta: "02 Traducción Textil",
      brand_step2_h3: "Diálogo Material",
      brand_step2_p: "Los datos de color se traducen en comportamiento de impresión y tejido conservando la profundidad tonal.",
      brand_step3_meta: "03 Realización Editorial",
      brand_step3_h3: "Expresión Portable",
      brand_step3_p: "Las prendas finales se moldean para una presencia cinematográfica, confort e identidad visual duradera.",
      ...
      col_lead: "Cada pieza se presenta como una obra de galería independiente con énfasis en forma, luz e impacto cromático.",
      ...
      lb_lead: "Imágenes de moda a gran escala diseñadas para sumergir al espectador antes de la decisión de compra.",
      lb_vol_eyebrow: "Volumen 01",
      lb_vol_h2: "Ecos de Campo de Color",
      lb_ch1_meta: "Capítulo 01",
      lb_ch1_h3: "Umbral",
      lb_ch1_p: "Una apertura tranquila donde la silueta se encuentra con la densidad cromática.",
      lb_ch2_meta: "Capítulo 02",
      lb_ch2_h3: "Interferencia",
      lb_ch2_p: "Los degradados de color cambian con el movimiento del cuerpo y la luz.",
      ...
      arc_lead: "El archivo fuente donde las obras abstractas son seleccionadas antes de transformarse en prendas.",
      ...
      shop_lead: "Tarjetas limpias, vistas previas en alta resolución y un marcador de pago seguro listo para futura integración de API.",
      shop_checkout_btn: "Marcador de Pago Seguro",
      shop_checkout_status: "Backend de pago listo para futura integración Stripe/Printful.",
      shop_footer_p: "Tienda TCDA",
      shop_footer_tech: "Marcado semántico, código ligero, visuales optimizados en WebP.",
      ...
      prod_cnj_art_p: "Inspirada en la pieza de archivo digital A-019, esta chaqueta captura la interferencia cian y el ritmo granular oscuro. La estructura está diseñada para preservar el impacto del color en movimiento.",
      ...
      prod_cnj_mat_li3: "Estampado: transferencia de alta fidelidad para precisión cromática",
      prod_cnj_mat_li4: "Producción: artesanía en pequeños lotes, fabricado en Japón",
      ...
      prod_cnj_status: "Integraciones futuras: Stripe, API de Printful, sistema de pedidos, cuentas de clientes.",
      prod_cnj_notice: "Se recomienda arquitectura compatible con Cloudflare y despliegue con HTTPS primero.",      prod_cnj_size_table: "Tabla de Tallas",
      prod_cnj_size_col_size: "Talla",
      prod_cnj_size_col_chest: "Ancho de Pecho",
      prod_cnj_size_col_sleeve: "Largo de Manga",
      prod_cnj_size_col_length: "Largo Total",      prod_related_eyebrow: "Productos Relacionados",
    ...
    ar: {
      ...
      home_lead: "دار أزياء فنية رقمية راقية تحوِّل التكوينات اللونية المجردة إلى تعبير يمكن ارتداؤه. تبدأ التجربة بالفن، ثم تنتقل إلى الفلسفة، ثم اكتشاف المنتج.",
      ...
      home_phi_p1: "تعامل TCDA الملابس كجدران معرض متحركة. يبدأ كل إصدار كعمل فني رقمي مجرد ويُترجم إلى نسيج وصورة ظلية وحركة.",
      home_phi_p2: "عالمنا مبني للكثافة الهادئة: مساحة محايدة، تصوير دقيق للألوان، وإيقاع بصري متعمد.",
      ...
      home_journey_p: "ابدأ بالانغماس في المعرض، وافهم الفلسفة، ثم اكتشف القطع المصممة للارتداء في العالم الحقيقي.",
      ...
      brand_lead: "توجد TCDA لدمج الفن الرقمي المجرد مع صناعة الملابس الراقية. نصمم قطعًا قابلة للارتداء تحمل البنية اللونية العاطفية في الحركة اليومية.",
      ...
      brand_concept_p: "يبدأ كل إصدار من لوحة رقمية أصلية. تُعيّن طبقات اللون والضوضاء والتدرجات على الملمس والقص والصورة الظلية، مع الحفاظ على الكثافة البصرية في الشكل المادي.",
      brand_method_eyebrow: "الفلسفة الإبداعية",
      brand_method_h2: "المنهج",
      brand_method_p: "نزيل الضوضاء البصرية حتى يتنفس العمل الفني. البيئات المحايدة والطباعة المنضبطة والتباعد السينمائي تضع التركيز حيث ينتمي: على اللون والشكل.",
      ...
      brand_step1_p: "يُولَّد العمل الأصلي ويُنتقى للعاطفة والإيقاع والدقة اللونية.",
      brand_step2_meta: "٠٢ الترجمة النسيجية",
      brand_step2_h3: "حوار المواد",
      brand_step2_p: "تُترجم بيانات اللون إلى سلوك البطاقة والقماش مع الحفاظ على العمق النغمي.",
      brand_step3_meta: "٠٣ الإدراك التحريري",
      brand_step3_h3: "تعبير قابل للارتداء",
      brand_step3_p: "تُشكَّل الملابس النهائية للحضور السينمائي والراحة والهوية البصرية الدائمة.",
      ...
      col_lead: "تُقدَّم كل قطعة كعمل معرض مستقل مع التركيز على الشكل والضوء والتأثير اللوني.",
      ...
      arc_lead: "أرشيف المصدر حيث تُنتقى الأعمال المجردة قبل تحويلها إلى ملابس.",
      ...
      shop_lead: "بطاقات نظيفة، معاينات عالية الدقة، ونقطة دفع آمنة جاهزة لتكامل واجهة برمجة التطبيقات المستقبلية.",
      shop_checkout_btn: "نقطة الدفع الآمنة",
      shop_checkout_status: "الواجهة الخلفية للدفع جاهزة لتكامل Stripe/Printful المستقبلي.",
      ...
      prod_cnj_art_p: "مستوحى من قطعة الأرشيف الرقمي A-019، يلتقط هذا الجاكيت التداخل السيان والإيقاع الحبيبي الداكن. الهيكل مصمم للحفاظ على تأثير اللون أثناء الحركة.",
      ...
      prod_cnj_status: "تكاملات مستقبلية: Stripe، Printful API، نظام الطلبات، حسابات العملاء.",
      prod_cnj_notice: "يُنصح بالبنية المتوافقة مع Cloudflare والنشر الذي يُعطي الأولوية لـ HTTPS.",
    ...
    ja: {
      ...
      cart_added: "追加済み",
      cart_add: "カートに追加",
      footer_tagline: "Transcend Color Digital Apparel / アートを着る、感性を解放する。",
      footer_tech: "HTTPS対応、Cloudflare互換、セキュアチェックアウトプレースホルダー搭載。",
      skip_link: "コンテンツへスキップ",
      home_eyebrow: "Transcend Color Digital Apparel",
      home_h1_html: "アートを着る、<br />感性を解放する。",
      home_lead: "抽象的なクロマティック構成が着用可能な表現となる、プレミアムデジタルアートアパレルハウス。体験はまずアートから始まり、哲学へ、そしてプロダクトの発見へと続きます。",
      ...
      home_phi_p1: "TCDAは、ガーメントを動く美術館の壁として扱います。すべてのドロップは抽象デジタルアート作品から始まり、テキスタイル、シルエット、そしてモーションへと翻訳されます。",
      home_phi_p2: "私たちの世界は静かな強度のために構築されています。ニュートラルな空間、正確な色彩再現、そして意図的なビジュアルリズム。",
      ...
      home_journey_p: "ギャラリーへの没入から始め、哲学を理解し、リアルワールドのウェアのために設計されたピースを発見してください。",
      home_journey_shop: "コレクションをショップする",
      home_journey_lookbook: "ルックブックを開く",
      brand_eyebrow: "ブランド",
      brand_h1_html: "アートが衣服になり、<br />衣服が声になる。",
      brand_lead: "TCDAは、抽象デジタルアートとプレミアムガーメントクラフトを融合させるために存在します。日常の動きに感情的なカラーアーキテクチャを運ぶ着用可能な作品をデザインしています。",
      brand_hero_img_alt: "デジタルアートファッションガーメントを形成するクリエイティブディレクター",
      brand_concept_eyebrow: "ウェアラブルアート",
      brand_concept_h2: "コンセプト",
      brand_concept_p: "各リリースはオリジナルのデジタルキャンバスから始まります。色彩、ノイズ、グラデーションのレイヤーがテクスチャ、カット、シルエットにマッピングされ、物理的な形にビジュアルの強度が保持されます。",
      brand_method_eyebrow: "クリエイティブフィロソフィー",
      brand_method_h2: "メソッド",
      brand_method_p: "アート作品が息吹けるよう視覚的ノイズを取り除きます。ニュートラルな環境、規律ある組版、映画的なスペーシングが、色と形という本来の場所に焦点を当てます。",
      brand_process_eyebrow: "ストーリーテリング",
      brand_process_h2: "3ステップクリエイティブプロセス",
      brand_step1_meta: "01 アート制作",
      brand_step1_h3: "デジタル抽象",
      brand_step1_p: "オリジナルアートワークは感情、リズム、クロマティックな精度のために生成・キュレーションされます。",
      brand_step2_meta: "02 テキスタイル翻訳",
      brand_step2_h3: "素材との対話",
      brand_step2_p: "カラーデータはトーンの深みを保ちながら、プリントと生地の振る舞いに翻訳されます。",
      brand_step3_meta: "03 エディトリアル実現",
      brand_step3_h3: "ウェアラブル表現",
      brand_step3_p: "最終的なガーメントは映画的な存在感、快適さ、そして持続するビジュアルアイデンティティのために形成されます。",
      brand_footer_p: "TCDAブランドストーリー",
      brand_footer_link: "コレクションへ続く",
      col_eyebrow: "コレクション",
      col_h1: "着用可能なカラーワークスのギャラリー",
      col_lead: "各アイテムは形、光、そしてクロマティックな影響に焦点を当てた独立したギャラリーピースとして提示されます。",
      ...
      lb_lead: "プロダクト決定前に視聴者を没入させるために設計された大規模ファッションイメージ。",
      lb_vol_eyebrow: "ボリューム 01",
      lb_vol_h2: "カラーフィールドのエコー",
      lb_ch1_meta: "チャプター 01",
      lb_ch1_h3: "しきい値",
      lb_ch1_p: "シルエットがクロマティックな密度と出会う、穏やかなオープニング。",
      ...
      arc_lead: "ガーメントに変換される前に抽象作品がキュレーションされるソースアーカイブ。",
      ...
      shop_lead: "クリーンなカード、高解像度プレビュー、そして将来のAPI統合に向けたセキュアチェックアウトプレースホルダー。",
      shop_checkout_btn: "セキュアチェックアウトプレースホルダー",
      shop_checkout_status: "チェックアウトバックエンドは将来のStripe/Printful統合に向けて準備済み。",
      shop_footer_p: "TCDAショップ",
      shop_footer_tech: "セマンティックマークアップ、軽量コード、WebP最適化ビジュアル。",
      ...
      prod_cnj_art_p: "デジタルアーカイブ作品A-019からインスピレーションを得たこのジャケットは、シアンの干渉とダークなグレイン状のリズムを捉えています。ストラクチャーは動きの中でカラーインパクトを保持するように設計されています。",
      ...
      prod_cnj_status: "将来の統合：Stripe、Printful API、注文システム、顧客アカウント。",
      prod_cnj_notice: "Cloudflare互換アーキテクチャとHTTPSファースト展開を推奨します。",
